...
func _ready():
	spawnItem("ball_basket", Vector2(-3300, 500))
	spawnItem("ball_volley", Vector2(-3300, 1050))
	spawnItem("ball_white", Vector2(-3300, 100))
	spawnItem("ball_wilson", Vector2(-3300, 200))
	spawnItem("book_blue", Vector2(-1250, 1050))
	spawnItem("book_red", Vector2(1250, 1050))
	spawnItem("book_green", Vector2(1500, 1050))
#	spawnItem("book_stack", Vector2(1500, 1050))
#	spawnItem("bowl", Vector2(1500, 1050))
#	spawnItem("candle_new", Vector2(1500, 1050))
...
#	spawnItem("plant", Vector2(-, ))
	...
	spawnItem("sword", Vector2(4500, 500))
	spawnItem("tape", Vector2(-2500, 1050))
	spawnItem("tea_cup", Vector2(-2500, 800))
	spawnItem("triforce", Vector2(-6000, 1050))
